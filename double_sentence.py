...
def chunk_text_with_page_titles(text, sentences_per_chunk=3):
    ...
    for page_index, page_content in enumerate(pages):
        ...
        # Chia thành các chunk có 3 câu mỗi chunk
...
# Chia văn bản thành các chunk (mỗi chunk có 3 câu)
chunks_with_titles = chunk_text_with_page_titles(content, sentences_per_chunk=2)
